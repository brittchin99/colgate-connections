class ConnectionsController < ApplicationController
    ...
    def index
        ...
        @connections = current_account.profile.connections.joins(:friend).group("connections.id").group("first_name")
        ...
        if params.has_key?("filter_list")
            ...
            if p.has_key?("sort_by")
                ...
                if sort_key == "Date Connected: Latest"
                    ...
                    @connections = @connections.joins(:friend).group("connections.id").group("first_name")
                end
            end
