class Profile < ApplicationRecord
  ...
  INTERESTS = ["Sports and Athletics", "Community Service", "Performing Arts", "Dance", "Anime", "Video Games", "E Sports", "Cooking", "Music","Politics", "Reading", "Culture","Outdoor Education"]
